...
export default class GridExample extends React.PureComponent {
	...
	render() {
		...
		return (
			<ContentBox>
				...
				<ContentBoxParagraph>
					Renders tabular data with virtualization along the vertical and horizontal axes. Row heights and column widths
					must be calculated ahead of time and specified as a fixed size or returned by a getter function.
				</ContentBoxParagraph>
	...
	_renderLeftSideCell({ key, rowIndex, style }) {
		...
		style = { ...style, backgroundColor: datum.color }
		return (
			<div className={classNames} key={key} style={style}>
				{datum.name.charAt(0)}
			</div>
