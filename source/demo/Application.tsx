					...
					<div className={styles.headerRow}>
						<div className={styles.logoRow}>
							...
							<ul className={styles.NavList}>
								...
								<NavLink href="https://github.com/bvaughn/react-virtualized" iconType={TYPES.SOURCE}>
									Source
								</NavLink>
								<NavLink
								...
								<NavLink href="https://github.com/bvaughn/react-virtualized/issues" iconType={TYPES.ISSUES}>
									Issues
								</NavLink>
							</ul>
						</div>
					...
					<div
						...
						<div className={styles.column}>
							...
							{Object.keys(COMPONENT_EXAMPLES_MAP).map((route) => (
								<Route key={route} path={route} component={COMPONENT_EXAMPLES_MAP[route]} />
							))}
