...
type SortDirectionMap = Record<string, SortDirection>
type MultiSortOptions = {
	defaultSortBy: Array<string> | null | undefined
	defaultSortDirection: SortDirectionMap | null | undefined
}
...
export default function createMultiSort(
	sortCallback: (...args: Array<any>) => any,
	...
	function sort({ defaultSortDirection, event, sortBy: dataKey }: SortParams): void {
		if (event.shiftKey) {
