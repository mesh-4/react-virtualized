...
type Props = {
	 ...
	 */
	children: (arg0: {
		onChildScroll: (arg0: { scrollTop: number }) => void
		registerChild: (arg0: Element | null | undefined) => void
		height: number
		isScrolling: boolean
		scrollLeft: number
		scrollTop: number
	...
	onResize: (arg0: { height: number; width: number }) => void

	/** Callback to be invoked on-scroll: ({ scrollLeft, scrollTop }) */
	onScroll: (arg0: { scrollLeft: number; scrollTop: number }) => void

	/** Element to attach scroll event listeners. Defaults to window. */
	scrollElement: (typeof window | Element) | null | undefined
...
export default class WindowScroller extends React.PureComponent<Props, State> {
	...
	state = { ...getDimensions(this.props.scrollElement, this.props), isScrolling: false, scrollLeft: 0, scrollTop: 0 }

	updatePosition(scrollElement: Element | null | undefined = this.props.scrollElement) {
