...
export default class WindowScrollerExample extends React.PureComponent<{}, State> {
	static contextTypes = {
	...
	_windowScroller: WindowScroller | null | undefined
	...
	render() {
		...
		return (
			<ContentBox>
				...
				{showHeaderText && (
					<ContentBoxParagraph>
						This component decorates <code>List</code>, <code>Table</code>, or any other component and manages the
						window scroll to scroll through the list
					</ContentBoxParagraph>
				)}
				...
				<WindowScroller ref={this._setRef} scrollElement={isScrollingCustomElement ? customElement : window}>
