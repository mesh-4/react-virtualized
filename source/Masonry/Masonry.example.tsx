...
export default class GridExample extends React.PureComponent {
	...
	render() {
		...
		if (windowScrollerEnabled) {
			child = <WindowScroller overscanByPixels={overscanByPixels}>{this._renderAutoSizer}</WindowScroller>
		} else {
		...
		return (
			<ContentBox>
				...
				<ContentBoxParagraph>
					Optimized for masonry layouts. Cells are j.i.t. measured and layed out as a user scrolls. Sizes are cached so
					that resize/reflow is fast and does not require re-measuring.
				</ContentBoxParagraph>
	...
	_cellRenderer({ index, key, parent, style }) {
		...
		return (
			<CellMeasurer cache={this._cache} index={index} key={key} parent={parent}>
				<div className={styles.Cell} style={{ ...style, width: columnWidth }}>
					<div
						style={{
