...
class Masonry extends React.PureComponent<Props, State> {
	...
	_onScrollMemoized: number | null | undefined = null
	_scrollingContainer: HTMLElement | null | undefined = null
	...
	render() {
		...
		if (shortestColumnSize < scrollTop + height + overscanByPixels && measuredCellCount < cellCount) {
			const batchSize = Math.min(
				...
				Math.ceil(
					(((scrollTop + height + overscanByPixels - shortestColumnSize) / cellMeasurerCache.defaultHeight) * width) /
...
type OnCellsRenderedCallback = (params: { startIndex: number; stopIndex: number }) => void
