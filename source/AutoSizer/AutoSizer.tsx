...
export default class AutoSizer extends React.Component<Props, State> {
	...
	_window: any | null | undefined // uses any instead of Window because Flow doesn't have window type
    ...
    */
		return (
			<div className={className} ref={this._setRef} style={{ ...outerStyle, ...style }}>
