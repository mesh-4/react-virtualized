...
import DynamicWidthGrid from './CellMeasurer.DynamicWidthGrid.example'
import DynamicHeightGrid from './CellMeasurer.DynamicHeightGrid.example'
import DynamicWidthMultiGrid from './CellMeasurer.DynamicWidthMultiGrid.example'
import DynamicHeightList from './CellMeasurer.DynamicHeightList.example'
import DynamicHeightTableColumn from './CellMeasurer.DynamicHeightTableColumn.example'
				...
				<AutoSizer disableHeight>
					{({ width }) => (
						<div
							...
							<DemoComponent getClassName={getClassName} getContent={getContent} list={list} width={width} />
						</div>
					)}
				</AutoSizer>
			</ContentBox>
