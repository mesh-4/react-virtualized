...
export default class DynamicHeightTableColumn extends React.PureComponent {
	...
	render() {
		...
		return (
			<Table
				...
				<Column width={width - 200} dataKey="random" label="Dynamic text" cellRenderer={this._columnCellRenderer} />
			</Table>
		)
	}
	...
	_columnCellRenderer = ({ dataKey, parent, rowIndex }) => {
		...
		return (
			<CellMeasurer cache={this._cache} columnIndex={0} key={dataKey} parent={parent} rowIndex={rowIndex}>
				<div
