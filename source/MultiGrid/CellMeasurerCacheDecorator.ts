...
export default class CellMeasurerCacheDecorator {
	...
	getHeight(rowIndex: number, columnIndex: number | null | undefined = 0): number | null | undefined {
		return this._cellMeasurerCache.getHeight(rowIndex + this._rowIndexOffset, columnIndex + this._columnIndexOffset)
	}

	getWidth(rowIndex: number, columnIndex: number | null | undefined = 0): number | null | undefined {
