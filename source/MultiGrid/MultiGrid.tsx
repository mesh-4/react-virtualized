...
class MultiGrid extends React.PureComponent {
	...
	static getDerivedStateFromProps(nextProps, prevState) {
		if (nextProps.scrollLeft !== prevState.scrollLeft || nextProps.scrollTop !== prevState.scrollTop) {
			return {
				scrollLeft:
					nextProps.scrollLeft != null && nextProps.scrollLeft >= 0 ? nextProps.scrollLeft : prevState.scrollLeft,
	...
	_cellRendererBottomLeftGrid = ({ rowIndex, ...rest }) => {
		...
		if (rowIndex === rowCount - fixedRowCount) {
			...
			return cellRenderer({ ...rest, parent: this, rowIndex: rowIndex + fixedRowCount })
		}
	}
	...
	_cellRendererTopRightGrid = ({ columnIndex, ...rest }) => {
		...
		if (columnIndex === columnCount - fixedColumnCount) {
			...
			return cellRenderer({ ...rest, columnIndex: columnIndex + fixedColumnCount, parent: this })
		}
	}
		...
		if (hideBottomLeftGridScrollbar) {
			return (
				<div
					...
					style={{ ...this._bottomLeftGridStyle, height, width, overflowY: 'hidden' }}>
					{bottomLeftGrid}
				</div>
			)
		}
		...
		if (hideTopRightGridScrollbar) {
			return (
				<div
					...
					style={{ ...this._topRightGridStyle, height, width, overflowX: 'hidden' }}>
					{topRightGrid}
				</div>
			)
		}
